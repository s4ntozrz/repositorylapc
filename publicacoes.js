...
const producoesDaLiga = [
    {
        ...
        autores: ['Diretoria de Pesquisa LAPC'],
        ano: '2025',
        arquivo: 'arquivo/-.pdf'
    },
];
...
const artigosParaEstudo = [
    {
        ...
        ano: '2023',
        arquivo: 'arquivos_publicacoes/SAÚDE MENTAL NA UNIVERSIDADE - 2023 UFAL.pdf'
    },
];

// VARIÁVEL DE ESTADO - Guarda a contagem de posts visíveis para cada seção
let visiblePostsCount = {};

/**
 * Função que desenha os posts na tela, com todas as funcionalidades.
 */
function renderizarPosts(lista, elementoId, tituloSecao) {
    ...
    container.innerHTML = ''; // Limpa a seção
...
// (Diferente do script.js principal, este não precisa do DOMContentLoaded
// pois ele já é chamado no final do <body> da publicacoes.html)
